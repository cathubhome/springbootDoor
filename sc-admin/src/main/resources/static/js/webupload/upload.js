(function ($) {
    ...
    $(function () {
        //获取文件格式限制
        var extensions = '';
        // var getDoucmentForamts = "getForamts";
        // $.ajax({
        //     url: getDoucmentForamts,
        //     async: false,
        //     success: function (data) {
        //         if (data != '') {
        //             if (data['status'] == 'SUCCEED') {
        //                 extensions = data['reponse'];
        //             }
        //         }
        //     }
        // });
        var $wrap = $('#uploader'),
            ...
            //服务器路径
//			serverRootUrl = 'http://localhost:8080/mdm_app',		//TODO 地址
            checkUrl = 'check',
            uploadUrl = 'upload',
        ...
        WebUploader.Uploader.register({
            ...
            beforeSendFile: function (file) {
                ...
                fileName = file.name;
                fileSize = file.size;
                (new WebUploader.Uploader()).md5File(file, 0, 20 * 1024 * 1024).progress(function (percentage) {
                }).then(function (val) {
                    fileMd5 = val;
                    var url = checkUrl;
                    var data = {
        ...
        uploader = WebUploader.create({
            ...
            accept: {
                title: '单文档上传文件格式限制',
                extensions: 'txt,zip,doc,docx'
            },
            // 禁掉全局的拖拽功能。这样不会出现图片拖进页面的时候，把图片打开。
            disableGlobalDnd: true,
            fileNumLimit: 50,//限制多文件上传的个数
            fileSizeLimit: 10000 * 1024 * 1024, // 限制所有文件的大小
            fileSingleSizeLimit: 200 * 1024 * 1024// 限制单个文件的大小 200M
        });
        ...
        function addFile(file) {
            ...
            if (file.getStatus() === 'invalid') {
                ...
                uploader.makeThumb(file, function (error, src) {
                    ...
                    if (isSupportBase64) {
                        ...
                        $.ajax('../../server/preview.do', {//TODO 图片预览
                            method: 'POST',
                            data: src,
                            dataType: 'json'
            ...
            $btns.on('click', 'span', function () {
                ...
                if (supportTransition) {
                    ...
                    //         $wrap.css( 'encodingFilter', "progid:DXImageTransform.Microsoft.Matrix(M11=" + cos + ",M12=" + (-sin) + ",M21=" + sin + ",M22=" + cos + ",SizingMethod='auto expand')");
                    //     }
                    // });
                }
...
//						alert('上传成功');
        ...
        uploader.onError = function (code) {
            if (code == "F_DUPLICATE") {
                ...
                alert("所选附件总大小不可超过10000M哦！");
            }
            else if (code == "F_EXCEED_SIZE") {
                alert("所选单个附件大小不可超过200M哦！换个小点的文件吧！");
            }
            else if (code == "Q_EXCEED_NUM_LIMIT") {
                alert("所选总附件个数不可超过25个哦！");
            }
