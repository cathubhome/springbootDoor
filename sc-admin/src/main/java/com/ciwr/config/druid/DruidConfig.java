...
public class DruidConfig {
    ...
    public ServletRegistrationBean druidServlet() {
        ServletRegistrationBean servletRegistrationBean = new ServletRegistrationBean(new StatViewServlet(), druidRegistrationUrl);
        //登录查看信息的账号密码.
    ...
    public DruidDataSource dataSource() {
        logger.info("DruidDataSource Loading... ");
